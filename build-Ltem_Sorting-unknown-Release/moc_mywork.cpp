...
QT_MOC_LITERAL(1, 7, 7), // "decoded"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 11), // "std::string"
QT_MOC_LITERAL(4, 28, 11), // "decodedText"
QT_MOC_LITERAL(5, 40, 22), // "std::vector<cv::Point>"
QT_MOC_LITERAL(6, 63, 6) // "points"

    },
    "MyWork\0decoded\0\0std::string\0decodedText\0"
    "std::vector<cv::Point>\0points"
};
...
void MyWork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->decoded((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< const std::vector<cv::Point>(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyWork::*)(const std::string & , const std::vector<cv::Point> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWork::decoded)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyWork::decoded(const std::string & _t1, const std::vector<cv::Point> & _t2)
{
