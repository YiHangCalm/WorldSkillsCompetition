...
"}\n"
"QPushButton#baiyun {\n"
"    border-image: url(:/new/btn/Rese/baiyun.png);\n"
"    \n"
"     width: 203;  \n"
"    height: 60px; \n"
"	font"
...
"}\n"
"QPushButton#bishui {\n"
"    border-image: url(:/new/btn/Rese/bishui.png);\n"
"    \n"
"     width: 203;  \n"
"    height: 60px; \n"
"	font-size: 16px;\n"
...
"}\n"
"QPushButton#yunting {\n"
"    border-image: url(:/new/btn/Rese/yunting.png);\n"
"    \n"
"     width: 130;  \n"
"    height: 60px; \n"
"	font-size: 16px;\n"
...
"}"));
        ...
        tableWidget->setGeometry(QRect(0, 0, 712, 431));
        ...
        widget2->setGeometry(QRect(30, 450, 661, 101));
        horizontalLayout = new QHBoxLayout(widget2);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        yunting = new QPushButton(widget2);
        yunting->setObjectName(QString::fromUtf8("yunting"));
        yunting->setFont(font1);

        horizontalLayout->addWidget(yunting);

        bishui = new QPushButton(widget2);
        bishui->setObjectName(QString::fromUtf8("bishui"));
        bishui->setFont(font1);

        horizontalLayout->addWidget(bishui);

        baiyun = new QPushButton(widget2);
        baiyun->setObjectName(QString::fromUtf8("baiyun"));
        baiyun->setFont(font1);

        horizontalLayout->addWidget(baiyun);
    ...
    void retranslateUi(QMainWindow *qrcode)
    {
        ...
        yunting->setText(QString());
        bishui->setText(QString());
        baiyun->setText(QString());
    } // retranslateUi
